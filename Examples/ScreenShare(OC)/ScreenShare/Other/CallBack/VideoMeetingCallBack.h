...
- (void)videoMeetingCallBack:(VideoMeetingCallBack *)callback notifyScreenShareCtrlMouseMsg:(int)eventType xPos:(int)xPos yPos:(int)yPos mouseData:(int)mouseData;

- (void)videoMeetingCallBack:(VideoMeetingCallBack *)callback notifyScreenShareCtrlKeyMsg:(int)keyCode bExtendedKey:(BOOL)bExtendedKey bKeyDonw:(BOOL)bKeyDonw;
